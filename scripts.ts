...
var hasbattergem: boolean = false;
var haskey: boolean = false;
var hasknife: boolean = false;
var hasletter: boolean = false;
var haswrench: boolean = false;
...
{
  //Starter situation
  if($("#background").attr("src") == "Image resources/ambackground01.png" && haswrench == false) 
  {
    alert("Tool is needed to open this stuck door!");
  } 
  else if($("#background").attr("src") == "Image resources/ambackground01.png" && haswrench == true) 
  {
    $("#wrench").remove();
  ...
  if($("#background").attr("src") == "Image resources/ambackground08.png" && haskey == false) 
  {
    alert("Key is needed!");
    $("#background").prop("src", "Image resources/ambackground07.png");
  } 
  else if($("#background").attr("src") == "Image resources/ambackground08.png" && haskey == true) 
  {
    $("#key").remove();
    $("#moveleft").remove();
    $("#moveright").remove();
  ...
  else if($("#background").attr("src") == "Image resources/ambackground05.png") 
  {
    haskey = true;
  ...
  if($("#background").attr("src") == "Image resources/ambackground04.png" && hasknife == false) 
  {
    alert("Sharp tool is needed to open them!");
  } 
  else if($("#background").attr("src") == "Image resources/ambackground04.png" && hasknife == true) 
  {
    hasletter = true;
