...
var hasiron:boolean = false;
var hasfan:boolean = false;
var hasgreen:boolean = false;
var hasblue:boolean = false;
var redplaced:boolean = false;
var greenplaced:boolean = false;
var blueplaced:boolean = false;
var fanplaced:boolean = false;
var redbuttonclicked:number = 0;
var greenbuttonclicked:number = 0;
var yellowbuttonclicked:number = 0;
var lightbluebuttonclicked:number = 0;
var lightgreenbuttonclicked:number = 0;
var purplebuttonclicked:number = 0;
var orangebuttonclicked:number = 0;
var brownbuttonclicked:number = 0;
var bluebuttonclicked:number = 0;
...
$("#intro").on("click", function () 
{
  ...
  else if($("#background").attr("src") == "Image resources/Intropartimage.png") 
  {
...
function showIt(event) 
{
  ...
  if($("#background").attr("src") == "Image resources/Ambackground03.png") 
  {
    ...
    else if(x >= 165 && x <= 610 && y >= 395 && y <= 510 && hasletter == true) 
    {
  ...
  if($("#background").attr("src") == "Image resources/Ambackground08.png") 
  {
    ...
    if(x >= 115 && x <= 125 && y >= 325 && y <= 380 && hasfan == false && hasred == true) 
    {
      alert("Put the fan into first!");
    }
    if(x >= 115 && x <= 125 && y >= 435 && y <= 485 && hasfan == false && hasblue == true)
    {
      alert("Put the fan into first!");
    }
    if(x >= 115 && x <= 125 && y >= 530 && y <= 580 && hasfan == false && hasgreen == true) 
    {
      alert("Put the fan into first!");
    }
  } 
  else if($("#background").attr("src") == "Image resources/Ambackground09.png") 
  {
  ...
  else if ($("#background").attr("src") == "Image resources/Ambackground10.png") 
  {
  ...
  else if($("#background").attr("src") == "Image resources/Ambackground11.png")
  {
  ...
  if($("#background").attr("src") == "Image resources/Ambackground15.png") 
  {
    ...
    else if(x >= 285 && x <= 565 && y >= 225 && y <= 595 && greenplaced == true && greenbuttonclicked != 1 && yellowbuttonclicked != 2 && redbuttonclicked != 3) 
    {
      alert("Hit in the password by using the colored buttons! Password length: 3");
    }
    ...
    else if(x >= 160 && x <= 180 && y >= 340 && y <= 370 && greenplaced == true) 
    {
      //yellow button
    ...
    else if(x >= 205 && x <= 225 && y >= 340 && y <= 370 && greenplaced == true) 
    {
      //light green button
      lightgreenbuttonclicked = 1;
    } 
    else if(x >= 105 && x <= 130 && y >= 400 && y <= 425 && greenplaced == true) 
    {
      //light blue button
      lightbluebuttonclicked = 1;
    } 
    else if(x >= 160 && x <= 180 && y >= 400 && y <= 425 && greenplaced == true) 
    {
      //purple button
      purplebuttonclicked = 1;
    } 
    else if(x >= 205 && x <= 225 && y >= 400 && y <= 425 && greenplaced == true) 
    {
      //orange button
      orangebuttonclicked = 1;
    } 
    else if(x >= 105 && x <= 130 && y >= 450 && y <= 475 && greenplaced == true) 
    {
      //brown button
      brownbuttonclicked = 1;
    } 
    else if(x >= 160 && x <= 180 && y >= 450 && y <= 475 && greenplaced == true) 
    {
      //blue button
      bluebuttonclicked = 1;
    } 
    else if(x >= 205 && x <= 225 && y >= 450 && y <= 475 && greenplaced == true) 
    {
      //green button
    ...
    else if(x >= 285 && x <= 565 && y >= 225 && y <= 595 && greenbuttonclicked == 1 && yellowbuttonclicked == 2 && redbuttonclicked == 3) 
    {
      $("#moveright").remove();
      $("#moveleft").remove();
...
$("#moveright").on("click", function () 
{
  ...
  else if($("#background").attr("src") == "Image resources/Ambackground02.png") 
  {
    alert("I have to enter that ship!");
  } 
  else if($("#background").attr("src") == "Image resources/Ambackground03.png") 
  {
    $("#background").prop("src", "Image resources/Ambackground04.png");
  } 
  else if($("#background").attr("src") == "Image resources/Ambackground04.png") 
  {
    $("#background").prop("src", "Image resources/Ambackground06.png");
  } 
  else if($("#background").attr("src") == "Image resources/Ambackground06.png") 
  {
    $("#background").prop("src", "Image resources/Ambackground13.png");
  } 
  else if($("#background").attr("src") == "Image resources/Ambackground13.png") 
  {
    alert("Ouch! Wall!");
  } 
  else if($("#background").attr("src") == "Image resources/Ambackground07.png") 
  {
    $("#background").prop("src", "Image resources/Ambackground06.png");
  } 
  else if($("#background").attr("src") == "Image resources/Ambackground08.png") 
  {
    $("#background").prop("src", "Image resources/Ambackground07.png");
  } 
  else if($("#background").attr("src") == "Image resources/Ambackground14.png") 
  {
    alert("Ouch! Wall!");
  } 
  else if($("#background").attr("src") == "Image resources/Ambackground15.png") 
  {
    $("#background").prop("src", "Image resources/Ambackground14.png");
  } 
  else if($("#background").attr("src") == "Image resources/Ambackground09.png")
  ...
  else if($("#background").attr("src") == "Image resources/Ambackground12.png")
  {
    $("#background").prop("src", "Image resources/Ambackground07.png");
  }
});
...
$("#moveleft").on("click", function () 
{
  ...
  else if($("#background").attr("src") == "Image resources/Ambackground07.png" && fanplaced == false) 
  {
    $("#background").prop("src", "Image resources/Ambackground08.png");
  } 
  else if($("#background").attr("src") == "Image resources/Ambackground07.png" && fanplaced == true) 
  {
    $("#background").prop("src", "Image resources/Ambackground12.png");
  } 
  else if($("#background").attr("src") == "Image resources/Ambackground08.png") 
...
$("#letter").on("click", function ()
{
  if(hasletter == true)
  {
    alert("Whoever among the good people read this: start the engine of the ship!");
  }
});
...
$("#littlenote").on("click", function () 
{
  if(hasnote == true) 
  {
    alert("Password to the navigation room: inverse of the colors of the fuses!");
  }
});